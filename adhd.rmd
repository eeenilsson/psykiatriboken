...
**Atomoxtin** (SNRI) kan ha en viss ångestlindrande effekt. Metaboliseras via CYP2D6 och kan därför vara svårt att kombinera med SSRI. 
...
Någon evidensbaserad åtgörd finns ej, men planerade uppehåll (drug holidays) eller byte till annat preparat kan provas.
