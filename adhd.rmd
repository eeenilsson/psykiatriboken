...
**Tabell \@ref(table-adhd-farmacokinetics)** visar farmakokinetiska egenskaper hos olika läkemedel mot ADHD.

```{r table-adhd-farmacokinetics, caption = "Tabell farmakokinetik ADHD-läkemedel" } 

knitr::kable(tbl1, align = "llccc")

``` 

**Tabell \@ref(table-adhd-dosing)** visar dosering för olika läkemedel mot ADHD.

```{r table-adhd-dosing, caption = "Tabell dosering ADHD-läkemedel" } 

knitr::kable(tbl2, align = "llccc")
