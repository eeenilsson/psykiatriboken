...
tbl_long[, lty := "solid"]
tbl_long[variable %in% c("methylphenidateimmediate", "methylphenidateextended"), lty := "dashed"]
tbl_long$lty

p <- ggplot(tbl_long, aes(x=time, y=value_relative, group=variable, color=variable, linetype = lty))
## p + geom_line()
...
p + guides(lty = FALSE) + theme(panel.grid.minor = element_blank())
