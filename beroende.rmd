...
De _basala ganglierna_ är en samling områden i hjärnan som är inblandade i flera funktioner, bland annat inlärning, motorik, känslor och kognition. Den beroendeframkallande effekten av vissa droger kan förklaras med olika processer där de basala ganglierna är inblandade. Deras anatomi och övergripande funktioner beskrivs i kapitel \@ref(nervsystemet), stycke \@ref(basala-ganglierna). Här följer en beskrivning av hur olika strukturer och processer i hjärnan är kopplade till beroende.

_Striatum_ kallas ett område i hjärnan som har betydelse för vår förmåga att välja mellan olika impulser för att nå bästa möjliga utfall. Detta område ingår i hjärnans belöningssystem, som aktiveras av droger. [@Volkow:2015]

När en beroendeframkallande drog (exemplevis kokain, amfetamin eller nikotin) används påverkas nervceller belägna i mitthjärnan (lat. _mesencephalon_), närmare bestämt den del av den "svarta substansen" (lat. _sustanta nigra_) som _benämns par compacta_, så att de via sina axoner frisätter höga nivåer dopamin till ett område i striatum kallat accumbenskärnan (lat. _nucleus accumbens_). Där finns celler med D1-receptorer som ingår i den sk "direkta banan" som leder till desinhibering av _thalamus_, vilket främjar beteendet[belöning?]. Där finns även celler med D2-receptorer som ingår i den "indirekta banan" som via _ventrala pallidum_ hämmar thalamus, vilket och är kopplad till bestraffning. Senare forskning har visat att celler med D1 receptorer även ingår i den indirekta banan och att celler med D2-receptorer ingår i den direkta banan. Förändrad aktivitet i båda dessa banor leder därmed till att beteendet förstärks.

Där finns celler med D1-receptorer vars aktivering leder till desinhibering av thalamus och stimulering av det drogsökande beteendet. Aktiveriung av andra cellgrupper, med D2-receptorer, leder istället till hämning av beteendet.
...
Striatal direct and indirect pathways control decision-making behavior [@Macpherson:2014]

Brain on drugs [@Volkow:2015].
